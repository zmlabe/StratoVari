"""
Composite SSW events for SC-WACCM4
...
def readData(exp):
    """
    Read in data for WACCM4 experiments
    """
    ### Import modules
    import numpy as np
    ...
    if exp == '1.1':
        experiment = 'PAMIP-1.1-QBO'
        experimentq = 'PAMIP_Cu'
        NENS = 300
        
    directorydata = '/seley/zlabe/simu/' + experimentq + '/daily/'
...
plt.title(r'\textbf{Climatology of SSW Events -- Polar Cap Heights -- SC-WACCM4-1.1}',fontsize=11)
...
plt.savefig(directoryfigure + 'SSWEvents_WACCM1.1_norm.png',dpi=300)
