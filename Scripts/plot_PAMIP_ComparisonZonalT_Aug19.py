...
if dataread == True:
    ###############################################################################
    anom_sstcu,climo_sstcu,p_sstcu,lat,lev = readDataPeriods('sst','TEMP',
                                                             ['SST_Fu','SST_Cu'],
                                                             periodm)
    anom_sstpi,climo_sstpi,p_sstpi,lat,lev = readDataPeriods('sst','TEMP',
                                                             ['SST_Fu','SST_Pi'],
                                                             periodm)
    ###############################################################################
    anom_antcu,climo_antcu,p_antcu,lat,lev = readDataPeriods('ant_sea_ice','TEMP',
                                                             ['ANT_Fu','ANT_Cu'],
                                                             periodma)
    anom_antpi,climo_antpi,p_antpi,lat,lev = readDataPeriods('ant_sea_ice','TEMP',
                                                             ['ANT_Fu','ANT_Pi'],
                                                             periodma)
    ###############################################################################
    anom_BKcu,climo_BKcu,p_BKcu,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['BKsea_Fu','Current'],
                                                             'JFM')
    anom_BKpi,climo_BKpi,p_BKpi,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['BKsea_Fu','Past'],
                                                             periodm)
    ###############################################################################
    anom_Ocu,climo_Ocu,p_Ocu,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['Osea_Fu','Current'],
                                                             periodm)
    anom_Opi,climo_Opi,p_Opi,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['Osea_Fu','Past'],
                                                             periodm)
    ###############################################################################
    anom_ARCcu,climo_ARCcu,p_ARCcu,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['Future','Current'],
                                                             periodm)
    anom_ARCpi,climo_ARCpi,p_ARCpi,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['Future','Past'],
                                                             periodm)
    ###############################################################################
    anom_SITcu,climo_SITcu,p_SITcu,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['SIT_Fu','SIT_Cu'],
                                                             periodm)
    anom_SITpi,climo_SITpi,p_SITpi,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
                                                             ['SIT_Fu','Past'],
                                                             periodm)
    ###############################################################################
    #anom_E3cu,climo_E3cu,p_E3cu,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
    #                                                         ['E3SM_Fu','E3SM_Cu'],
    #                                                         periodm)
    #anom_E3pi,climo_E3pi,p_E3pi,lat,lev = readDataPeriods('arc_sea_ice','TEMP',
    #                                                         ['E3SM_Fu','E3SM_Pi'],
    #                                                         periodm)
###############################################################################
